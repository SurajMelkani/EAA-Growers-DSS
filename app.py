...
st.set_page_config(page_title="EAA Growers DSS", page_icon="🌾", layout="wide")
    ...
    if st.session_state.step == 1:
        ...
        if crop_decision == "Recommend crops for me":
            ...
            with st.expander("🌍 Carbon & Emissions Data", expanded=False):
                ...
                # The legend is now perfectly tucked inside the expander
                st.info("💡 **How to read this table:**\n"
                "- **Carbon Credits:** 1 credit = 1 metric ton of CO₂ stored in your soil per year.\n"
                "- **CO₂ Released:** The emissions generated by farming operations (tractor fuel, fertilizer, etc.).\n"
                "- 🚗 **Real-World Impact:** An average passenger car emits about **4.6 tons of CO₂ per year**. So, generating 4.6 credits per hectare is like taking one car off the road for every hectare you farm!")
